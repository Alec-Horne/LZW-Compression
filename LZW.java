 ...
 *  uses 9 - 12 bits for the dictionary entries. Once it hits 2^12 entries, the 
...
public class LZW {
    ...
    public static void compress(String p) {
        ...
        try {
			os2 = new FileOutputStream(fileName + ".lzw");
    ...
    public static void decompress(String p, String type) {
        ...
        File newFile = new File(fileName + "2" + fileType);
    	FileWriter fw = null;
